...
export default function Counter({ characters = 0, maxLength = 300 }) {
  ...
  const compensation = progress >= 90 ? 7 : 8

  let primaryColor = progress >= 90 ? "#FFAD1F" : "#999fff"
  const secondaryColor = "#999fff"
